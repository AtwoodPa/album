...
该模板中也提供了使用的一个范例，在 `top.sharehome.springbootinittemplate.mongo` 包中，如果想了解更多，可以自行前往 MongoDB 官方网站学习或者前往模板作者的 [MongoDB 笔记仓库](https://github.com//mongodb-notes)入门。
...
如果想拥有正真意义上的服务器推送功能，目前有两种解决方案，第一种是 Server-Send Event（SSE） 单工通信机制，第二种是 WebSocket 全双工通信机制，该模板中给出了基于 Netty 框架搭建的 WebSocket 相关配置，具体编码方法请见：[Netty 学习示例仓库](https://github.com//netty-study-demo)。
...
![Star History Chart](https://api.star-history.com/svg?repos=/spring-boot-init-template&type=Date)
