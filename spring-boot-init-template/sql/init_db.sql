...
-- Records of t_log
-- ----------------------------
INSERT INTO `t_log` VALUES (1800928335635660801, '/api/auth/login', '用户登录', 0, 'POST', 'top.sharehome.springbootinittemplate.controller.AuthController.login', 1900, '172.20.10.3', '0|0|0|内网IP|内网IP', '{\"account\":\"admin\"}', 0, '{\"msg\":\"登录成功\",\"code\":200,\"data\":{\"res\":{\"account\":\"admin\",\"id\":1900,\"name\":\"\",\"role\":\"admin\"}}}', 8914, '2024-06-13 00:29:10', '2024-06-13 00:29:10', 0);
INSERT INTO `t_log` VALUES (1800928616662417409, '/api/auth/info', '用户获取个人信息', 3, 'GET', 'top.sharehome.springbootinittemplate.controller.AuthController.info', 1900, '172.20.10.3', '0|0|0|内网IP|内网IP', '{}', 0, '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"account\":\"admin\",\"id\":1900,\"name\":\"\",\"role\":\"admin\"}}', 24, '2024-06-13 00:30:17', '2024-06-13 00:30:17', 0);
...
INSERT INTO `t_log` VALUES (1800929054031855618, '/api/user/update/name', '用户更新自身名称', 4, 'PUT', 'top.sharehome.springbootinittemplate.controller.user.UserController.updateName', 1900, '172.20.10.3', '0|0|0|内网IP|内网IP', '{\"newName\":\"\"}', 1, '{\"msg\":\"账号名称已经存在 ==> [不能和当前名称重复]\",\"code\":11001,\"name\":\"USERNAME_ALREADY_EXISTS\"}', 3, '2024-06-13 00:32:01', '2024-06-13 00:32:01', 0);
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1900, 'admin', 'FBWzA2jdoO9tjpiK3rKTbw==', '1911261716@qq.com', 0, '', NULL, 'admin', 0, '2024-03-27 22:01:16', '2024-08-10 12:38:09', 0);
